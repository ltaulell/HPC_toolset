...
# coding: utf-8
#
# $Id: ibmap2slurm.py 3516 2021-10-29 12:47:02Z ltaulell $
                    ...
                    if m.groups()[0] == 'Switch':
                        ...
                        if hostmap:
                            ...
                            if current_node in hostmap.keys():
                                ...
                                topology[current_node]['label'] = hostname
                            else:
                                topology[current_node]['label'] = current_node
                        else:
                            topology[current_node]['label'] = current_node
...
def prepare_slurm_structure(topology, debug=None):
    """ Transform the topology in a table
    SwitchName=SwitchID Nodes=NodeSet(nodes)
    SwitchName=SwitchID Switches=NodeSet(switches)
